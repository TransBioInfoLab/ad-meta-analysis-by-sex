setwd("M:/AD/analysis/projects/Sex_strat/Aim3/Meta-analysis/Lissette/RosmapImputedData/mQTLanalysis_bySex/CpGs_SNPs_bySex/Male")
...
#male
overlapM <- read.csv("CpGsSNPsOverlap_male.csv")
