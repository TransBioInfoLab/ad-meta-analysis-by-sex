...
df.samples <- data.frame("Number of samples" =  c(nb.samples, 
                                                  nb.samples.bc.filtered,
                                                  nb.samples.with.clinical, 
                                                  nb.samples.with.clinical.after.pca.female + b.samples.with.clinical.after.pca.male),
                         ...
                         "Difference" = c("-",
                                          ...
                                          nb.samples.with.clinical.after.pca.female + b.samples.with.clinical.after.pca.male - nb.samples.with.clinical)
)    
df.samples           
