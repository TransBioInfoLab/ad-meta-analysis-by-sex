setwd("M:/AD/analysis/projects/Sex_strat/Aim3/Meta-analysis/Lissette/RosmapImputedData/mQTLanalysis_bySex/CpGs_SNPs_bySex/Female")
...
#female
# overlapF <- read.csv("CpGsSNPsOverlap_female.csv")
...
# identical(as.vector(RosmapCov$FID), colnames(SNPfileM)[-1])
# identical(as.vector(RosmapCov$FID), colnames(resMethyCpGsM_ADsign))
...
write.csv(allF_m1, "ADmqtlAnalysisResults_CpGs_female.csv")
saveRDS(allF_m1, "ADmqtlAnalysisResults_CpGs_female.rds")
...
write.csv(results, "ADmqtlAnalysisResults_CpGs_female_SNPglm.csv")
